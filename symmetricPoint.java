...
public class symmetricPoint {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer,Integer> hm=new HashMap<>();  // hashmap to store the key value pair
		
		for(int[] e:arr) {

			// this will check if the value is present as key already or not!
			if(hm.containsKey(e[1]) && hm.containsValue(e[0])) System.out.println(e[1]+" "+hm.get(e[1]));
